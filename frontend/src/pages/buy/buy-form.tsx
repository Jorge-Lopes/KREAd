    ...
    <BuyFormContainer>
      ...
      <StepContainer>
        <GeneralInfo active={!isOnFirstStep}>
          ...
          {isOnFirstStep && (
            <PrimaryButton data-cy="send-buy-offer-button" onClick={() => onSendOfferClickHandler()} disabled={isDisabled || notEnoughIST}>
      ...
      <ButtonContainer>
        {isOnFirstStep ? (
          ...
          <PrimaryButton data-cy="confirm-buy-offer-button" onClick={() => changeStep(CONFIRMATION_STEP)} disabled={changeStepDisabled.step2}>
            <ButtonText customColor={color.white}>{text.mint.confirm}</ButtonText>
